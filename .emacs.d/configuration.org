...
#+BEGIN_SRC emacs-lisp
      (with-eval-after-load 'evil-maps
        (progn
          ...
          (define-key my-leader-map (kbd "n") (lambda () (interactive) (find-file notes-file)))

          (define-key my-org-menu (kbd "c") 'org-capture)
          (define-key my-org-menu (kbd "a") 'org-agenda)
          (define-key my-org-menu (kbd "r") 'org-refile)

          (define-key my-nav-menu (kbd "s") 'bookmark-set)
          (define-key my-nav-menu (kbd "c") 'helm-filtered-bookmarks)
          (define-key my-nav-menu (kbd "m") 'helm-imenu)
          (define-key my-nav-menu (kbd "n") 'evil-buffer-new)
          ...
          (define-key my-window-menu (kbd "c") 'delete-window)
          (define-key my-window-menu (kbd "d") 'delete-other-windows)
