...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'sh-mode  'centered-cursor-mode)
  (add-hook 'js-mode  'centered-cursor-mode)
...
#+BEGIN_SRC emacs-lisp
  ...
  (defvar my-helm-menu (make-sparse-keymap))
  ...
  (define-key my-helm-menu (kbd "p") 'helm-projectile)
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq helm-boring-buffer-regexp-list (list (rx "*magit-") (rx "*helm") (rx "*Minibuf") (rx "*Echo area") (rx "*Treemacs-Framebuffer*") (rx "*which-key*")))
