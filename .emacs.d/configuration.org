...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-c m") my-multiterm-menu)
  (global-set-key (kbd "C-c p") my-perspective-menu)
  (global-set-key (kbd "C-c g") my-nav-menu)
  (global-set-key (kbd "C-c c") my-command-menu)
  (global-set-key (kbd "C-c t") my-treemacs-menu)
