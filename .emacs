...
(define-key xah-fly-dot-keymap (kbb "n") (lambda () (interactive) (find-file "~/Dropbox/Fiction/Notes.org"))

(define-key xah-fly-c-keymap (kbd "w") 'writegood-mode)
(define-key xah-fly--tab-key-map (kbd "t") 'toggle-truncate-lines)
(define-key xah-fly--tab-key-map (kbd "e") 'eval-defun)
