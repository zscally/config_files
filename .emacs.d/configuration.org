...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'rust-mode  'centered-cursor-mode)
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-hl-line-mode)
  (set-face-background hl-line-face "#C00000")
  (set-face-attribute 'evil-ex-lazy-highlight nil :foreground "grey" :background "darkGreen")
